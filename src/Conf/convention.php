...
//        'APP_AUTOLOAD_PATH'      => '', // 自动加载的路径 关闭APP_USE_NAMESPACE后有效 @todo remove in future
        ...
        'TMPL_ACTION_ERROR'      => __DIR__ . '/../Tpl/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
        'TMPL_ACTION_SUCCESS'    => __DIR__ . '/../Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
        'TMPL_EXCEPTION_FILE'    => __DIR__ . '/../Tpl/think_exception.tpl',// 异常页面的模板文件
...
//        'TAGLIB_LOAD'            => true, // 是否使用内置标签库之外的其它标签库，默认自动检测 @todo is duplicate?
        'TAGLIB_BUILD_IN'        => \Think\Template\TagLib\Cx::class, // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
