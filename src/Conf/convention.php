<?php
    ...
    return [
        ...
        'TMPL_ACTION_ERROR'      => __DIR__ . '/../Resources/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
        'TMPL_ACTION_SUCCESS'    => __DIR__ . '/../Resources/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
        'TMPL_EXCEPTION_FILE'    => __DIR__ . '/../Resources/think_exception.tpl',// 异常页面的模板文件
        ...
        /* URL设置 */
        'URL_CASE_INSENSITIVE'   => UrlCaseSensitivity::SENSITIVITY,   // 默认false 表示URL区分大小写 true则表示不区分大小写
        'URL_MODEL'              => UrlSchema::PATHINFO,       // URL访问模式,可选参数0、1、2、3,代表以下四种模式：
