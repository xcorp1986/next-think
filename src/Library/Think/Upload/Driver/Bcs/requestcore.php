<?php
    ...
    class BCS_RequestCore
    {
         ...
         *
         * @param array $curlopts (Optional) A set of key-value pairs that set `CURLOPT` options. These will merge with
         *                        the existing CURLOPTs, and ones passed here will override the defaults. Keys should
         *                        be the `CURLOPT_*` constants, not strings.
         * @return $this A reference to the current instance.
         */
         ...
         * </ul>
         *
         * @param string|array|function $callback (Required) The callback function is called by <php:call_user_func()>,
         *                                        so you can pass the following values: <ul>
         *                                        <li>The name of a global function to execute, passed as a
         *                                        string.</li>
         ...
         *                       <li><code>callback</code> - <code>string|array</code> - Optional - The string name of
         *                       a function to pass the response data to. If this is a method, pass an array where the
         ...
         *                       requests to make. This can be useful for scaling around slow server responses.
         *                       Defaults to trusting cURLs judgement as to how many to use.</li></ul>
